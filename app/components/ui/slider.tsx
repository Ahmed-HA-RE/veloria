  ...
  const renderThumb = (value: number) => {
    const thumb = (
      <SliderPrimitive.Thumb
        className='block size-4 shrink-0 rounded-full border border-amber-400 bg-white shadow-sm outline-none ring-ring/50 transition-[color,box-shadow] hover:ring-4 focus-visible:ring-4 disabled:pointer-events-none disabled:opacity-50'
    ...
    >
      ...
      >
        <SliderPrimitive.Range
          className={cn(
            'absolute bg-amber-400 data-[orientation=horizontal]:h-full data-[orientation=vertical]:w-full'
          )}
